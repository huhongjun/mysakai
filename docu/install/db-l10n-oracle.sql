...
-- /* 1. Table: sakai_site, Column: Title,Short_desc,Description */
		...
		update sakai_site set title='我的工作台',description='我的工作台' where SITE_ID='!user';
	
		-- worksite
		update sakai_site set title='模板站点',description='模板站点' where SITE_ID='!worksite';
	
		-- mercury site
		update sakai_site set title='mercury 站点',description='mercury 站点' where SITE_ID='mercury';
	
		-- Administration Workspace，管理员的个人站点（~admin）
		update sakai_site set title='我的工作台',description='我的工作台 - 系统管理员' where SITE_ID='~admin';
	
/* 2. Table: sakai_site_page */

    /**********    sakai_site_page 中英文对照列表    **********************************
    ...
    **********************************************************************************/
    ...
    -- 显示在admin用户管理的administration workspace 站点左侧列表
			...
			-- Memory
				update sakai_site_page set title='内存管理'	where PAGE_ID in('!admin-700');        
			-- Site Archive
...
/* 3. Table: sakai_site_tool */
   ...
   -- 显示在未登录页面右侧标题
    ...
    -- Welcome
    update sakai_site_tool set title='欢迎 - 创远在线学习管理系统!' where TOOL_ID in('!gateway-120');
    -- About
...
/* 4. Table: sakai_realm_role_desc */
    ...
    -- Can read, revise, delete and add both content and participants to a site.
		update sakai_realm_role_desc set description='教师' where ROLE_KEY='5';
		-- Can read content, and add content to a site where appropriate.
		update sakai_realm_role_desc set description='助教' where ROLE_KEY='8';
		-- Can read, add, and revise most content in their sections.
		update sakai_realm_role_desc set description='学生' where ROLE_KEY='9';
